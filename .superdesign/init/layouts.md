...
- Descrição: Layout raiz, tema, internacionalização e toaster.
...
export const metadata: Metadata = {
  ...
  description: 'CRM de vendas e atendimento pelo WhatsApp.',
  robots: {
    index: false,
    follow: false,
  },
...
- Descrição: Layout autenticado que delega ao shell.
...
- Caminho: `src/app/(dashboard)/dashboard-shell.tsx`
- Descrição: Shell responsivo com sidebar, header e conteúdo.
...
- Descrição: Navegação principal desktop e móvel.
...
- Descrição: Cabeçalho móvel, busca e menu lateral.
