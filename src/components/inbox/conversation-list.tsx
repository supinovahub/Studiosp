...
export function ConversationList({
  ...
  return (
    ...
    <aside
      ...
      className="bg-card flex h-full w-full flex-col lg:w-[21rem]"
    >
      {/* Search + Filter */}
      <div className="border-border/65 space-y-2.5 border-b p-3.5">
        <div className="relative">
          ...
          <Input
            ...
            className="border-border/70 bg-muted/55 text-foreground placeholder:text-muted-foreground focus:border-primary/50 h-10 rounded-xl pl-9 text-sm"
          />
        </div>
...
function ConversationItem({
  ...
  return (
    <button
      onClick={handleClick}
      className={cn(
        'border-border/55 hover:bg-muted/45 flex min-h-[4.75rem] w-full items-start gap-3 border-b px-3.5 py-3 text-left transition-colors',
