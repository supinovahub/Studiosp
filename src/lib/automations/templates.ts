    ...
    steps: [
      {
        ...
        step_config: {
          text: 'Olá! 👋 Agradecemos o contato. Nossa equipe responderá em breve.',
        },
      },
      {
        step_type: 'add_tag',
  ...
  out_of_office: {
    ...
    steps: [
      ...
      },
      {
        step_type: 'send_message',
        step_config: {
          text: 'Agradecemos a mensagem! Nossa equipe está fora do horário agora (9h às 18h) e responderá no início do próximo expediente.',
        },
        parent_index: 0,
        branch: 'yes',
      },
    ...
    steps: [
      {
        step_type: 'send_message',
        step_config: {
          text: 'Ótimo! Vamos ajudar com valores. Para começar, qual tipo de studio você procura?',
        },
      },
      {
        step_type: 'wait',
  ...
  follow_up_reminder: {
    ...
    steps: [
      ...
      },
      {
        step_type: 'send_message',
        step_config: {
          text: 'Passando para acompanhar: ficou alguma dúvida? Estamos à disposição para ajudar!',
        },
      },
    ],
  },
