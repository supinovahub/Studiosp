...
//
// Why the `studiosp_live_` prefix
//   - Self-identifying: a leaked string is instantly recognisable as
//     a Studiosp key (handy for secret-scanners like GitGuardian).
//   - Forward-compatible: leaves room for a `studiosp_test_` variant if
...
export const API_KEY_PREFIX = 'studiosp_live_';
