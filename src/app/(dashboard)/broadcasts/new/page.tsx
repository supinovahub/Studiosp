...
const steps = [
  ...
  { label: 'personalização', key: 'personalize' },
  { label: 'envio', key: 'send' },
] as const;
              ...
              <div className="flex items-center gap-2">
                <div
                  className={`flex h-8 w-8 items-center justify-center rounded-full text-xs font-medium transition-all ${
                    isCompleted
                      ? 'bg-primário texto-primário-primeiro plano'
                      : isActive
                        ? 'border-primary bg-primary/10 texto-primary border-2'
                        : 'fronteira fronteira-borda bg-silenciado texto-silenciado-primeiro plano'
                  }`}
                >
